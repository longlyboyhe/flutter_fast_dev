...
import 'package:flutter_fast_dev/components/gallery/picture_frame.dart';
import 'circle.dart';
import 'feedback_widget.dart';

/// create by 老贺 on 2020/10/21
                ...
                child: Wrap(
                  ...
                  children: [
                    buildItem(Icons.palette, () {
                      Navigator.of(context).pushNamed(XRouter.galley);
                    }),
                    ...
                    buildItem(Icons.settings, () {
                      Navigator.of(context).pushNamed(XRouter.setting);
                    }),
